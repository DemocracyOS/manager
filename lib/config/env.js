...
module.exports = {
  ...
  'deployment db': env.DEIS_DEPLOYMENT_DB ? JSON.parse(env.DEIS_DEPLOYMENT_DB) : undefined,
  'deployment env': env.DEIS_DEPLOYMENT_ENV ? JSON.parse(env.DEIS_DEPLOYMENT_ENV) : undefined,
