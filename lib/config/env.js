...
module.exports = {
  ...
  deis: {
    ...
    secure:     env.DEIS_SECURE == 'true' ? true : undefined
  },

  // The docker image of DemocracyOS/app that will be used for creating Deployments.
  deploymentImage: env.DEPLOYMENT_IMAGE,

  // (optional) internal Deis Docker registry for quick deployments
  deploymentInternalRegistry: env.DEPLOYMENT_INTERNAL_REGISTRY,
  ...
  // Reserved names that can't be used for deployment subdomains
  deploymentReservedNames: env.DEPLOYMENT_RESERVED_NAMES ? env.DEPLOYMENT_RESERVED_NAMES.split(',') : [],

  deploymentLinkProtocol: env.DEPLOYMENT_LINK_PROTOCOL ? env.DEPLOYMENT_LINK_PROTOCOL : 'http',
  ...
  deploymentEnv: {
    ...
    EXTERNAL_SETTINGS_URL:        env.DEPLOYMENT_ENV_EXTERNAL_SETTINGS_URL,
