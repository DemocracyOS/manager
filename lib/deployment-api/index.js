...
var log = require('debug')('manager:deployment-api');
...
app.delete('/:name', function(req, res) {
  ...
  api.deployment.get(name, function (err, deployment) {
    if (err) return res.json(500, err);
    if (!deployment) return res.json(500, new Error('Deployment not found.'));
