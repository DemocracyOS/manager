...
var reservedNames = config['reserved names'] || [];
DeploymentSchema.path('name').validate(function(val){
...
DeploymentSchema.methods.hasDeisInstance = function (){
  return !!this.deis_uuid;
}

DeploymentSchema.methods.setDeisInstance = function (app){
  this.deis_uuid = app.uuid;
  this.url = app.url;
  return this;
}

DeploymentSchema.methods.unsetDeisInstance = function (){
  this.deis_uuid = undefined;
  this.url = undefined;
  return this;
}

DeploymentSchema.methods.canAssignDeisInstance = function (){
